						...
						<form action="{{route('User.search')}}" method="GET" class="form-inline">
							<div class="search_option_one">
							    <div class="form-group" style="background: #ffffff">
							    	...
							    	<input type="text" style="background: #ffffff" autocomplete="off" spellcheck="false" class="form-control h70" name="search" id="searchinput2" placeholder="Carpintero, Electricista, Uñas, Bebidas">
							    </div>
							</div>
